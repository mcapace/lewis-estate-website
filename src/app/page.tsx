  ...
  return (
    <div className="min-h-screen bg-neutral-200">
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* Quote Section */}
        <div className="h-[500px] bg-[#0D0D0D] flex flex-col justify-center items-center px-64 pt-32">
        ...
        <div className="bg-[#0D0D0D] px-40 py-20">
        ...
        {/* Salon Privé Section */}
        <div className="relative h-[900px] bg-[#0D0D0D] overflow-hidden">
          <Image
