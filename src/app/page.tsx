...
export default function Home() {
  return (
    <div style={{width: '100vw', height: '6328px', position: 'relative', background: 'linear-gradient(180deg, #0D0D0D 0%, #1a1a1a 50%, #0D0D0D 100%)', margin: 0, padding: 0}}>
      <div style={{width: '1440px', left: '50%', top: '0px', transform: 'translateX(-50%)', position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
        ...
        <div style={{width: '1440px', height: '850px', paddingLeft: '155px', paddingRight: '155px', position: 'relative', background: 'var(--Brand-Black, #0D0D0D)', overflow: 'hidden', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', display: 'flex'}}>
          ...
          <div style={{alignSelf: 'stretch', flex: '1 1 0', position: 'relative', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', gap: '32px', display: 'flex'}}>
            <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: '24px', display: 'flex'}}>
              <div style={{alignSelf: 'stretch', textAlign: 'center', color: 'var(--Brand-White, white)', fontSize: '16px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', lineHeight: '18px', letterSpacing: '5.12px', wordWrap: 'break-word'}}>
                The Home of Big Reds and Sexy Chardonnays
              </div>
              <div style={{alignSelf: 'stretch', textAlign: 'center', color: '#E5C1A0', fontSize: '54px', fontFamily: 'Playfair Display, serif', fontWeight: '300', lineHeight: '64px', letterSpacing: '1.08px', wordWrap: 'break-word'}}>
            ...
            <div style={{alignSelf: 'stretch', paddingLeft: '80px', paddingRight: '80px', justifyContent: 'center', alignItems: 'flex-start', gap: '10px', display: 'inline-flex'}}>
              <div style={{flex: '1 1 0', textAlign: 'center', color: 'var(--UI-Lightest-Grey, #F4F4F4)', fontSize: '20px', fontFamily: 'Inter, sans-serif', fontWeight: '400', lineHeight: '32px', letterSpacing: '0.50px', wordWrap: 'break-word'}}>
          ...
          <div style={{width: '1440px', height: '128px', paddingLeft: '40px', paddingRight: '40px', paddingTop: '32px', paddingBottom: '32px', left: '0px', top: '0px', position: 'absolute', overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: '186px', display: 'inline-flex'}}>
            <div style={{width: '193px', height: '58px', position: 'relative'}}>
              <div style={{width: '168.88px', height: '45.92px', left: '12.06px', top: '6.04px', position: 'absolute', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '4px'}}>
                <div style={{color: '#000000', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px'}}>
                  WINE SPECTATOR
                </div>
              </div>
            </div>
            <div style={{left: '412px', top: '40px', position: 'absolute', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '40px', display: 'flex'}}>
              <div style={{height: '48px', paddingTop: '16px', paddingBottom: '16px', justifyContent: 'center', alignItems: 'center', gap: '10px', display: 'flex'}}>
                <div style={{textAlign: 'center', color: 'var(--UI-Lightest-Grey, #F4F4F4)', fontSize: '16px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', letterSpacing: '1.44px', wordWrap: 'break-word'}}>
                  wine tastings
                </div>
              </div>
              <div style={{height: '48px', paddingTop: '16px', paddingBottom: '16px', justifyContent: 'center', alignItems: 'center', gap: '10px', display: 'flex'}}>
              ...
              <div style={{height: '48px', paddingTop: '16px', paddingBottom: '16px', justifyContent: 'center', alignItems: 'center', gap: '10px', display: 'flex'}}>
                <div style={{textAlign: 'center', color: 'var(--Brand-White, white)', fontSize: '16px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', letterSpacing: '1.44px', wordWrap: 'break-word'}}>
                  wines
                </div>
              </div>
            </div>
        ...
        <div style={{width: '1440px', height: '500px', paddingTop: '135px', paddingLeft: '271px', paddingRight: '271px', background: '#0D0D0D', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '64px', display: 'flex'}}>
          <div style={{alignSelf: 'stretch', textAlign: 'center', color: '#E5C1A0', fontSize: '64px', fontFamily: 'Playfair Display, serif', fontWeight: '300', letterSpacing: '0.32px', wordWrap: 'break-word'}}>
            "A record of excellence that few<br/>California wineries can rival."
          </div>
          <div style={{alignSelf: 'stretch', textAlign: 'center', color: 'var(--Secondary-CTA-Gold-(Drk-BG), #EFE5DA)', fontSize: '18px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', lineHeight: '20px', letterSpacing: '5.76px', wordWrap: 'break-word'}}>
          ...
          <div style={{height: '1363px', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
            <div style={{justifyContent: 'flex-start', alignItems: 'flex-start', gap: '139px', display: 'inline-flex'}}>
              <div style={{width: '438px', paddingTop: '128px', paddingBottom: '256px', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '32px', display: 'inline-flex'}}>
                <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '24px', display: 'flex'}}>
                  <div style={{alignSelf: 'stretch', color: 'var(--Brand-White, white)', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', lineHeight: '18px', letterSpacing: '4.48px', wordWrap: 'break-word'}}>
                    A Sensory Experience
                  </div>
                  <div style={{color: '#E5C1A0', fontSize: '54px', fontFamily: 'Playfair Display, serif', fontWeight: '300', lineHeight: '64px', letterSpacing: '2.16px', wordWrap: 'break-word'}}>
                    Wine Tastings
                  </div>
                </div>
                <div style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '10px', display: 'inline-flex'}}>
                  <div style={{flex: '1 1 0', color: 'var(--UI-Lightest-Grey, #F4F4F4)', fontSize: '20px', fontFamily: 'Inter, sans-serif', fontWeight: '400', lineHeight: '32px', letterSpacing: '0.50px', wordWrap: 'break-word'}}>
                ...
                <div style={{height: '55px', paddingTop: '18px', paddingBottom: '19px', paddingLeft: '24px', paddingRight: '24px', background: '#D3A737', justifyContent: 'center', alignItems: 'center', gap: '10px', display: 'inline-flex'}}>
                  <div style={{textAlign: 'center', color: 'var(--Brand-Black, #0D0D0D)', fontSize: '16px', fontFamily: 'Inter, sans-serif', fontWeight: '600', textTransform: 'uppercase', lineHeight: '18px', letterSpacing: '0.64px', wordWrap: 'break-word'}}>
                    Book A wine tasting
                  </div>
                </div>
              </div>
            ...
            <div style={{width: '1130px', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '139px', display: 'inline-flex'}}>
              ...
              <div style={{width: '438px', paddingTop: '201px', paddingBottom: '256px', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '32px', display: 'inline-flex'}}>
                <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '24px', display: 'flex'}}>
                  <div style={{color: 'var(--Brand-White, white)', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: '400', textTransform: 'uppercase', lineHeight: '18px', letterSpacing: '4.48px', wordWrap: 'break-word'}}>
                    A Magical Interplay
                  </div>
                  <div style={{alignSelf: 'stretch', color: 'var(--Secondary-Light-Gold-(Drk-BG), #E5C1A0)', fontSize: '54px', fontFamily: 'Playfair Display, serif', fontWeight: '300', lineHeight: '54px', letterSpacing: '2.16px', wordWrap: 'break-word'}}>
                    Culinary Experiences
                  </div>
                </div>
                <div style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '10px', display: 'inline-flex'}}>
          ...
          <div style={{width: '1130px', left: '155px', top: '560px', position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: '32px', display: 'flex'}}>
            <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '32px', display: 'flex'}}>
              <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: '24px', display: 'flex'}}>
                ...
                <div style={{alignSelf: 'stretch', textAlign: 'center', color: 'var(--Secondary-Light-Gold-(Drk-BG), #E5C1A0)', fontSize: '54px', fontFamily: 'Playfair Display, serif', fontWeight: '300', lineHeight: '64px', letterSpacing: '2.16px', wordWrap: 'break-word'}}>
              Salon Privé
                </div>
              </div>
          ...
          <div style={{width: '1130px', left: '155px', top: '603px', position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: '32px', display: 'inline-flex'}}>
            <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '32px', display: 'flex'}}>
              <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: '24px', display: 'flex'}}>
                ...
                <div style={{textAlign: 'center', color: 'var(--Secondary-Light-Gold-(Drk-BG), #E5C1A0)', fontSize: '54px', fontFamily: 'Playfair Display, serif', fontWeight: '300', lineHeight: '64px', letterSpacing: '2.16px', wordWrap: 'break-word'}}>
          ...
          <div style={{paddingLeft: '848px', paddingRight: '155px', position: 'relative', overflow: 'hidden', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
            <div style={{width: '437px', paddingTop: '32px', paddingBottom: '40px', paddingLeft: '32px', paddingRight: '32px', background: 'var(--Brand-Black, #0D0D0D)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '24px', display: 'flex'}}>
              <div style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '16px', display: 'flex'}}>
                <div style={{width: '389px', color: '#E5C1A0', fontSize: '32px', fontFamily: 'Playfair Display, serif', fontWeight: '400', lineHeight: '32px', letterSpacing: '0.64px', wordWrap: 'break-word'}}>
                  Lewis Cellars
                </div>
                <div style={{width: '389px', opacity: '0.80', color: '#F4F4F4', fontSize: '20px', fontFamily: 'Inter, sans-serif', fontWeight: '400', lineHeight: '32px', letterSpacing: '0.50px', wordWrap: 'break-word'}}>
