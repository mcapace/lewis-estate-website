...
export default function Home() {
  return (
    <main className="bg-black text-white">
      ...
      {/* Wine Cellar Section */}
      <section className="min-h-screen bg-black flex flex-col justify-center items-center px-6 py-20">
      ...
      <section className="min-h-screen bg-black flex items-center px-6 py-20">
        <div className="max-w-6xl mx-auto w-full">
